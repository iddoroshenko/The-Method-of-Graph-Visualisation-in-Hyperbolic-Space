...
public class H3Graph
{
    ...
    public H3Graph(int numNodes, int numLinks, String _arg)
    {
	...
	////// iddoroshenko test
		...
		try(FileWriter writer = new FileWriter(arg, true)){
	...
	////// iddoroshenko test
		...
		writer.append(' ');
		//Double.toString()
		writer.append(Double.toString(p.x));
		writer.append(' ');
		writer.append(Double.toString(p.y));
		writer.append(' ');
		writer.append(Double.toString(p.z));
		writer.append('\n');
		writer.flush();
		}
